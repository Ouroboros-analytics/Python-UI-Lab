...
# Form implementation generated from reading ui file 'class_helper.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushActivity.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.activityList.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lessonList.sizePolicy().hasHeightForWidth())
        ...
        self.gridLayout.addItem(spacerItem3, 10, 9, 1, 1)
        ...
        self.action00_Lesson_name_Solved.setObjectName("action00_Lesson_name_Solved")
        ...
        self.menu_Settings.addAction(self.menu_Weekly_Setup_Format.menuAction())
        ...
        self.lessonList.currentIndexChanged['int'].connect(self.activityList.update)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "TA Toolbox - Class Helper"))
        ...
        self.menu_Weekly_Setup_Format.setTitle(_translate("MainWindow", "&Weekly Setup Format"))
        self.menu_Commit_Msg.setTitle(_translate("MainWindow", "&Commit Msg"))
        self.action_Set_Lesson_Plans.setText(_translate("MainWindow", "Set Lesson Plans"))
        self.action_Set_Class_Repo.setText(_translate("MainWindow", "Set Class Repo"))
        self.action_Set_Class_Repo.setStatusTip(_translate("MainWindow", "Set a location for the class repository"))
        self.action_Dark_Mode.setText(_translate("MainWindow", "&Dark Mode"))
        self.actionOne_Activity.setText(_translate("MainWindow", "One Activity"))
        self.actionAll_Unsolved.setText(_translate("MainWindow", "All Unsolved"))
        self.actionLesson_Name_Solved.setText(_translate("MainWindow", "Lesson_Name - Solved"))
        self.action00_Solved.setText(_translate("MainWindow", "00 - Solved"))
        self.action00_Lesson_name_Solved.setText(_translate("MainWindow", "00-Lesson_name - Solved"))
